...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $user_internal_id = field_value_checker("User ID", $_GET['user_internal_id']);
 ...
 u_address, u_state, u_country, u_phone_number, u_account_status, u_qr_link, u_internal_hash from user_table WHERE u_internal_hash = '$user_internal_id'";
